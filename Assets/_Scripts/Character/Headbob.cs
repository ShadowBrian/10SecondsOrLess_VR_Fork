...
public class Headbob : MonoBehaviour
{
    ...
    void Update()
    {
        if (controller.isGrounded)
        {
            ...
            if (GameManager.Instance.controlsManager.moveInput.x != 0 || GameManager.Instance.controlsManager.moveInput.y != 0) //moving
            {
                ...
                camPos = newPosition;
                transform.localPosition = camPos + CameraShake.instance.shakeOffset; ; 
